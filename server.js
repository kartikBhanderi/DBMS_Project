...
app.post("/user/signup" , (req,res) => {
    ...
    signup.su( fn,ln,dob,addr,pwd,gender,branch,aadhar,acctype,interest, (result) => {
        if(result == false) 
        {
...
app.post('/manager/getinput',(req,res)=>{
    ...
    minp.fetchrec(a1nm,a1vl,a2nm,a2vl,a3nm,a3vl,a4nm,a4vl,a5nm,a5vl, (result)=>{
        if(result){
...
app.post('/employee/addemp',(req,res)=>{
    ...
    eadd.addemp(fname,lname,req.body.dob,gender,id,pwd,address, (result)=>{
        if(result){
            res.redirect('/employee/eaccess');
        } else {
...
app.post('/employee/getinput',(req,res)=>{
    ...
    console.log(a4nm+"->"+a4vl);
    console.log(a5nm+"->"+a5vl);
    ninp.fetchrec(a1nm,a1vl,a2nm,a2vl,a3nm,a3vl,a4nm,a4vl,a5nm,a5vl, (result)=>{
        if(result){
